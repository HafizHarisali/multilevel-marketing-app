                ...
                <div class="bg-white b-b wrapper-md">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <h1 class="m-n h3">Rejected / Cancelled Requests</h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="region region-content">
                                <div id="block-system-main" class="block block-system clearfix">
                                    ...
                                    <div class="eps-view view view-withdrawal-requests view-id-withdrawal_requests view-display-id-page_3 view-dom-id-5734c9fc144d3dca8c033e8f5f22f6a9">
                                        ...
                                        <div class="panel panel-default panel-filter">
                                            ...
                                            <div class="panel-collapse view-filters collapse" aria-expanded="false" style="height: 0px;">
                                                <div class="panel-body">
                                                    <form action="{{route('withdrawal_rejected_export')}}" method="get" id="" accept-charset="UTF-8" siq_id="autopick_4104">
                                            ...
                                            <div class="view-content">
                                                <div class="table-responsive">
                                                    <table class="views-table cols-7 table">
                                                        ...
                                                        <tbody>
                                                            @foreach($withdraw_reject  as $row)
                                                ...
                                                <div class="text-center">{{$withdraw_reject->links()}}</div>
                                            </div>
                                        </div>
                                        @else
                                        <div class="panel panel-default panel-view">
                                            <h5 class="text-center">No Rejected Requests</h5>
                                        </div>
                                        @endif
                                    </div>
                                </div>
