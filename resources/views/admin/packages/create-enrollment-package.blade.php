                        ...
                        <div class="col-md-12">
                            <div class="region region-content">
                                <div id="block-system-main" class="block block-system clearfix">
                                    ...
                                    <form action="{{route('insert_package')}}" method="post" id="commerce-product-ui-product-form" accept-charset="UTF-8" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="field-type-commerce-price field-name-commerce-price field-widget-commerce-price-full form-wrapper" id="edit-commerce-price">
                                                <div id="commerce-price-add-more-wrapper">
                                                    <div class="form-item clearfix form-type-textfield form-item-commerce-price-und-0-amount form-group">
                                                        ...
                                                        <input type="text" id="edit-commerce-price-und-0-amount" name="price" value="" size="10" maxlength="128" class="form-text form-control input-lg-3 required" />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="edit-status" class="form-radios">
                                                    <div class="form-item clearfix form-type-radio form-item-status radio">
                                                        <label class="i-checks">
                                                            <input type="radio" id="edit-status-1" name="status" value="0" checked="checked" class="form-radio radio" /><i></i></label>
                                                        <label class="option" for="edit-status-1">Active </label>

                                                    </div>
                                                    <div class="form-item clearfix form-type-radio form-item-status radio">
                                                        <label class="i-checks">
                                                            <input type="radio" id="edit-status-0" name="status" value="1" class="form-radio radio" /><i></i></label>
                                                        <label class="option" for="edit-status-0">Disabled </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions form-wrapper" id="edit-actions">
                                                <input type="submit" id="edit-submit" name="op" value="Save Package" class="form-submit btn btn-default btn-primary" /><a href="/admin/commerce/products">Cancel</a></div>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.block -->
