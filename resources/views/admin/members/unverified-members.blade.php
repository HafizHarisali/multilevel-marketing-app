                ...
                <div class="bg-light lter b-b wrapper-md">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <h1 class="m-n h3">Unverified Members List</h1>
                                ...
                                <div id="block-system-main" class="block block-system clearfix">
                                    <div class="view view-manage-members view-id-manage_members view-display-id-page view-dom-id-7dcf229004c154cee7faed0948f9ec0d">
                                        <div class="view-filters">
                                            <form action="{{route('search_unverified_members')}}" method="get" id="views-exposed-form-manage-members-page" accept-charset="UTF-8">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr class="odd views-row-first">
                                                                            ...
                                                                            <td class="views-field views-field-field-afl-sponsor">
                                                                                <a href="#">{{$row->sponsor}}</a> <span class="text-primary">(12)</span> </td>
                                                                            ...
                                                                            <td class="views-field views-field-status">
                                                                                @if($row->user_status == 0) Active @elseif($row->user_status == 1) Blocked
                                                                                @else
                                                                                Unverified
                                                                                 @endif </td>
