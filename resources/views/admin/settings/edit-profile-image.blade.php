                ...
                <div class="bg-light lter b-b wrapper-md">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <h1 class="m-n h3">
                                Edit Profile Image profile for {{Session::get('username')}}
                            </h1>
                        </div>
                        <!-- sreeram -->
                        ...
                        <div class="col-md-12">
                            <div class="region region-content">
                                <div id="block-system-main" class="block block-system clearfix">
                                    ...
                                    <form class="node-form node-cover-form" enctype="multipart/form-data" action="{{route('update_profile_image',$data->id)}}" method="post" id="promotional-banners-node-form" accept-charset="UTF-8">
                                        @csrf
                                        <div>
                                            <div class="field-type-image field-name-field-banner-image field-widget-image-image form-wrapper" id="edit-field-cover-image">
                                                <div id="edit-field-banner-image-und-0-ajax-wrapper">
                                                    <div class="form-item clearfix form-type-managed-file form-item-field-cover-image-und-0 form-group" data-toggle="tooltip" title="" data-original-title="Files must be less than 1 GB.Allowed file types: png gif jpg jpeg.">
                                                        <label for="edit-field-banner-image-und-0-upload">Profile Image </label>
                                                        <input type="file" name="profile_image" class="form-file" id="imgInp">
                                                        <div class="image-widget form-managed-file clearfix">
                                                            <div class="image-preview">
                                                                <img id="cover-image-edit" src="{{asset('public/assets/images/users/profiles')}}/{{$data->image}}" width="100" height="100" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
